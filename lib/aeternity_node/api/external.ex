...
defmodule AeternityNode.Api.External do
  ...
  {:error, info} on failure
  """
  @spec get_channel_by_pubkey(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.Channel.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_contract(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.ContractObject.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_contract_code(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.ByteCode.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_contract_po_i(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.PoI.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_contract_store(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.ContractStore.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_name_entry_by_name(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.NameEntry.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_oracle_by_pubkey(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.RegisteredOracle.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_oracle_queries_by_pubkey(Tesla.Env.client, String.t, keyword()) :: {:ok, AeternityNode.Model.OracleQueries.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_oracle_query_by_pubkey_and_query_id(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, AeternityNode.Model.OracleQuery.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_peer_pubkey(Tesla.Env.client, keyword()) :: {:ok, AeternityNode.Model.InlineResponse2003.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec get_status(Tesla.Env.client, keyword()) :: {:ok, AeternityNode.Model.Status.t} | {:error, Tesla.Env.t}
